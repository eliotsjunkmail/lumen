...
if (Math.abs(playGrowScale(1) - 1.5) > 1e-9) {
  throw new Error("full grow should be 1.5× width and height");
}
if (Math.abs(playGrowScale(0.5) - 1.25) > 1e-9) throw new Error("mid grow should be 1.25×");
if (Math.abs(layoutSizeWithGrow(1.65, 1) - 2.475) > 1e-9) {
  throw new Error("full grow should reserve 1.5× layout width");
}
